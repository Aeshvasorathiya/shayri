...
class data_class {
  static List lnt = [
    data_class.love.length,
    data_class.life.length,
    data_class.pyar.length,
    data_class.anay.length,
    data_class.politics.length,
    data_class.Love.length,
    data_class.sad.length,
    data_class.Remeber.length
  ];
