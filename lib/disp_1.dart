...
import 'package:shayri/fourth.dart';


class disp_1 extends StatefulWidget {
  int index;
  List<dynamic> a, list;

  disp_1(this.index, this.a, this.list);

  @override
  State<disp_1> createState() => _dispyState();
}

class _dispyState extends State<disp_1> {
  bool clr_sts = false;
  int ind1 = 0;
  int ind2 = 1;
  ...
  Widget build(BuildContext context) {
    double scr_hi = MediaQuery.of(context).size.height;
    double stats_bar = MediaQuery.of(context).padding.top;
          ...
          Flexible(
            child: Row(
                ...
                children: [
                                ...
                                itemBuilder: (context, index) {
                                  return InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text("${widget.a[widget.index]}",style: TextStyle(fontSize: 15),maxLines: 1),
                  ...
                  Text("${widget.index + 1}/${data_class.lnt[widget.index]}"),
                  InkWell(
                      onTap: () {
                        clr_sts = true;
                ...
                return Padding(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          gradient:
                              LinearGradient(colors: [data_class.clr[ind1], data_class.clr[ind2]])),
                      child: Padding(
                  ...
                  child: InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(
                          builder: (context) {
                            return edit_page(widget.a, widget.index, ind1, ind2);
                          },
                        ));
                      },
                      child:
